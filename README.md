...
## Starting the game
You can change the server port in constants.py and run server.py
Two players start window.py and start the game
Or download the executable file from repository and run it
